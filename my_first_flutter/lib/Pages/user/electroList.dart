...
class electroList extends StatefulWidget {
  final String idUser;

  electroList({required this.idUser});

  @override
  State<electroList> createState() => _electroListState();
}

class _electroListState extends State<electroList> {
